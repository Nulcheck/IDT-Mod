...
public class TEIDTAPI {
	public static void pulverizerRecipes() {
		...
		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.VanadiumOre), new ItemStack(mod_IDT.VanadiumDust, 2),
				true);

		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.TantalumOre), new ItemStack(mod_IDT.TantalumDust, 2),
				true);

		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.SulfurOre), new ItemStack(mod_IDT.Sulfur, 6), true);

		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.BoronOre), new ItemStack(mod_IDT.BoronDust, 2), true);

		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.CopperOre), new ItemStack(mod_IDT.CopperDust, 2),
				true);

		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.TitaniumOre), new ItemStack(mod_IDT.TitaniumDust, 2),
				true);
		...
		// Dimensional
		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.Agate), new ItemStack(mod_IDT.PureQuartz, 6), true);
		...
		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.UraniumIngot), new ItemStack(mod_IDT.UraniumDust, 1),
				true);
		...
		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.BoronIngot), new ItemStack(mod_IDT.BoronDust, 1),
				true);

		PulverizerManager.addRecipe(energy, new ItemStack(mod_IDT.CopperIngot), new ItemStack(mod_IDT.CopperDust, 1),
				true);
