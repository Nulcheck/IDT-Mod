...
public class RenderNetherBrick extends TileEntitySpecialRenderer {
	public static final ResourceLocation texture = new ResourceLocation("mod_idt",
			"/textures/models/wall_part/wall_part_nether_brick.png".substring(1));
	public WallPartModel model;

	public RenderNetherBrick() {
