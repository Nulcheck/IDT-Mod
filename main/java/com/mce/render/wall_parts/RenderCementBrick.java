...
public class RenderCementBrick extends TileEntitySpecialRenderer {
	public static final ResourceLocation texture = new ResourceLocation("mod_idt",
			"/textures/models/wall_part/wall_part_cement_brick.png".substring(1));
	public WallPartModel model;

	public RenderCementBrick() {
