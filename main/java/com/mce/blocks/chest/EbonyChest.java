...
public class EbonyChest extends BlockContainer {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (stack.hasDisplayName()) {
			((TileEntityEbonyChest) world.getTileEntity(x, y, z))
	...
	public void onNeighborBlockChange(World world, int x, int y, int z,
		...
		TileEntityEbonyChest tileentitychest = (TileEntityEbonyChest) world
				.getTileEntity(x, y, z);
	...
	public IInventory func_149951_m(World world, int x, int y, int z) {
		Object object = (TileEntityEbonyChest) world.getTileEntity(x, y, z);
		...
		if (object == null) {
			...
			if (world.getBlock(x - 1, y, z) == this) {
				object = new InventoryLargeChest(
						"container.ebonyChestDouble",
						(TileEntityEbonyChest) world.getTileEntity(x - 1, y, z),
						(IInventory) object);
			}

			if (world.getBlock(x + 1, y, z) == this) {
				object = new InventoryLargeChest("container.ebonyChestDouble",
						(IInventory) object,
						(TileEntityEbonyChest) world.getTileEntity(x + 1, y, z));
			}
			...
			if (world.getBlock(x, y, z - 1) == this) {
				object = new InventoryLargeChest(
						"container.ebonyChestDouble",
						(TileEntityEbonyChest) world.getTileEntity(x, y, z - 1),
						(IInventory) object);
			}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		TileEntityEbonyChest tileentitychest = new TileEntityEbonyChest();
	...
	public int isProvidingWeakPower(IBlockAccess blockacc, int x, int y, int z,
		...
		if (!this.canProvidePower()) {
			...
			int i1 = ((TileEntityEbonyChest) blockacc.getTileEntity(x, y, z)).numPlayersUsing;
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_
				.registerIcon("mod_IDT:planks_ebony");
	}
