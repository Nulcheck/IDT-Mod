...
public class JungleChest extends BlockContainer {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (stack.hasDisplayName()) {
			((TileEntityJungleChest) world.getTileEntity(x, y, z))
	...
	public void onNeighborBlockChange(World world, int x, int y, int z,
		...
		TileEntityJungleChest tileentitychest = (TileEntityJungleChest) world
				.getTileEntity(x, y, z);
	...
	public IInventory func_149951_m(World world, int x, int y, int z) {
		Object object = (TileEntityJungleChest) world.getTileEntity(x, y, z);
		...
		if (object == null) {
			...
			if (world.getBlock(x - 1, y, z) == this) {
				object = new InventoryLargeChest("container.jungleChestDouble",
						(TileEntityJungleChest) world
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		TileEntityJungleChest tileentitychest = new TileEntityJungleChest();
	...
	public int isProvidingWeakPower(IBlockAccess blockacc, int x, int y, int z,
		...
		if (!this.canProvidePower()) {
			...
			int i1 = ((TileEntityJungleChest) blockacc.getTileEntity(x, y, z)).numPlayersUsing;
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_.registerIcon("planks_jungle");
	}
