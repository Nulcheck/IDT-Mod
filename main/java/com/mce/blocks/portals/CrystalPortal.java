...
import com.mce.handlers.dimensions.teleporters.TeleportCrystal;
...
public class CrystalPortal extends BlockBreakable {
	public static final int[][] field_150001_a = new int[][] { new int[0], { 3, 1 }, { 2, 0 } };

	public CrystalPortal() {
		super("mod_IDT:portal_crystal", Material.portal, false);
	...
	public boolean getPortalSize(World world, int x, int y, int z) {
		CrystalPortal.Size size = new CrystalPortal.Size(world, x, y, z, 1);
		CrystalPortal.Size size1 = new CrystalPortal.Size(world, x, y, z, 2);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != mod_IDT.crystalDimId) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, mod_IDT.crystalDimId,
						new TeleportCrystal(thePlayer.mcServer.worldServerForDimension(mod_IDT.crystalDimId)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0,
						new TeleportCrystal(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
	...
	public static class Size {
		...
		public Size(World world, int x, int y, int z, int side) {
			...
			this.field_150863_d = CrystalPortal.field_150001_a[side][0];
			this.field_150866_c = CrystalPortal.field_150001_a[side][1];
		...
		protected int func_150858_a() {
			...
			for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g) {
				...
				for (j = 0; j < this.field_150868_h; ++j) {
					k = this.field_150861_f.posX
							+ j * Direction.offsetX[CrystalPortal.field_150001_a[this.field_150865_b][1]];
					l = this.field_150861_f.posZ
							+ j * Direction.offsetZ[CrystalPortal.field_150001_a[this.field_150865_b][1]];
					...
					if (block == mod_IDT.CrystalPortal) {
						++this.field_150864_e;
					}
			...
			for (i = 0; i < this.field_150868_h; ++i) {
				j = this.field_150861_f.posX
						+ i * Direction.offsetX[CrystalPortal.field_150001_a[this.field_150865_b][1]];
		...
		protected boolean func_150857_a(Block block) {
			return block.getMaterial() == Material.air || block == mod_IDT.CrystalFire
					|| block == mod_IDT.CrystalPortal;
		}
		...
		public void func_150859_c() {
			for (int i = 0; i < this.field_150868_h; ++i) {
				...
				for (int l = 0; l < this.field_150862_g; ++l) {
					...
					this.field_150867_a.setBlock(j, i1, k, mod_IDT.CrystalPortal, this.field_150865_b, 2);
				}
			}
		}
	}
