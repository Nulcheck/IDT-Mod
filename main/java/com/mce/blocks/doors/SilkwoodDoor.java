...
public class SilkwoodDoor extends Block {
	...
	public SilkwoodDoor(Material mat) {
		super(mat);
		float f = 0.5F;
		float f1 = 1.0F;
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		...
		this.iconTop[0] = p_149651_1_
				.registerIcon("mod_IDT:silkwood_door_upper");
		this.iconBottom[0] = p_149651_1_
				.registerIcon("mod_IDT:silkwood_door_lower");
	...
	public Item getItemDropped(int id, Random rand, int meta) {
		return mod_IDT.SilkwoodDoorItem;
	}
