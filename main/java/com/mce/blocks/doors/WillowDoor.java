...
public class WillowDoor extends Block {
	...
	public WillowDoor(Material mat) {
		super(mat);
		float f = 0.5F;
		float f1 = 1.0F;
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		...
		this.iconTop[0] = p_149651_1_.registerIcon("mod_IDT:willow_door_upper");
		this.iconBottom[0] = p_149651_1_
				.registerIcon("mod_IDT:willow_door_lower");
