...
public class EbonySapling extends BlockSapling implements IGrowable {
	private IIcon[] textures;
	public static final String[] SAPLINGNAMES = new String[] { "ebony" };
	...
	public EbonySapling() {
		tree = new WorldGenEbonyTree(true);
		tree1 = new WorldGenEbonyTree(true, 4, 0, 0, false);
