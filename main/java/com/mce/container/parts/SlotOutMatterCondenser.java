...
public class SlotOutMatterCondenser extends Slot {
	private EntityPlayer thePlayer;
	private int number;
	private static final String __OBFID = "CL_00001749";

	public SlotOutMatterCondenser(EntityPlayer player, IInventory inv, int x, int y, int z) {
		super(inv, x, y, z);
	...
	protected void onCrafting(ItemStack stack) {
		...
		if (stack.getItem() == mod_IDT.DarkMatterPiece) {
			this.thePlayer.addStat(AchRegistry.dmPiece, 1);
		}
	}
}