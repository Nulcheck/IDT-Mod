...
public class ItemRenderQuartz implements IItemRenderer {
	private wallPart model;

	public ItemRenderQuartz() {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityWPQuartz(), 0.0D, -0.1D, 0.0D, 0.0F);
	}
}
