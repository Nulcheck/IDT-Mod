...
public class ItemRenderDarkOak implements IItemRenderer {
	private wallPart model;

	public ItemRenderDarkOak() {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityWPDarkOak(), 0.0D, -0.1D, 0.0D, 0.0F);
	}
}
