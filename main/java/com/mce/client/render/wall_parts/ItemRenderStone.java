...
public class ItemRenderStone implements IItemRenderer {
	private wallPart model;

	public ItemRenderStone() {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityWPStone(), 0.0D, -0.1D, 0.0D, 0.0F);
	}
}
