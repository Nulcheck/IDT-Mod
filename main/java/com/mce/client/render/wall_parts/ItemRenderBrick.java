...
public class ItemRenderBrick implements IItemRenderer {
	private wallPart model;

	public ItemRenderBrick() {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityWPBrick(), 0.0D, -0.1D, 0.0D, 0.0F);
	}
}
