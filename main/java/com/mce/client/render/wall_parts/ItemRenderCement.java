...
public class ItemRenderCement implements IItemRenderer {
	private wallPart model;

	public ItemRenderCement() {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityWPCement(), 0.0D, -0.1D, 0.0D, 0.0F);
	}
}
