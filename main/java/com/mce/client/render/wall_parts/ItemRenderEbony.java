...
public class ItemRenderEbony implements IItemRenderer {
	private wallPart model;

	public ItemRenderEbony() {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityWPEbony(), 0.0D, -0.1D, 0.0D, 0.0F);
	}
}
