...
public class ClientRenderEbonyChest extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation normal_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/normal_double_ebony.png".substring(1));

	private static final ResourceLocation normal_single = new ResourceLocation(
			"mod_idt", "/textures/entity/chest/normal_ebony.png".substring(1));
	...
	public void renderTileEntityChestAt(
			TileEntityEbonyChest par1TileEntityChest, double par2, double par4,
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		renderTileEntityChestAt((TileEntityEbonyChest) par1TileEntity, par2,
				par4, par6, par8);
	}
