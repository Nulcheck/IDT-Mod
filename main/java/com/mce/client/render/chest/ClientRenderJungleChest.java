...
public class ClientRenderJungleChest extends TileEntitySpecialRenderer {
	private static final ResourceLocation trap_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/trapped_double_jungle.png".substring(1));

	private static final ResourceLocation trap_single = new ResourceLocation(
			"mod_idt", "/textures/entity/chest/trapped_jungle.png".substring(1));

	private static final ResourceLocation normal_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/normal_double_jungle.png".substring(1));

	private static final ResourceLocation normal_single = new ResourceLocation(
			"mod_idt", "/textures/entity/chest/normal_jungle.png".substring(1));
	...
	public ClientRenderJungleChest() {
	...
	public void renderTileEntityChestAt(
			TileEntityJungleChest par1TileEntityChest, double par2,
		...
		if (!par1TileEntityChest.hasWorldObj()) {
			...
			if (block instanceof JungleChest && i == 0) {
				try {
					((JungleChest) block).unifyAdjacentChests(
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
			double par4, double par6, float par8) {
		renderTileEntityChestAt((TileEntityJungleChest) par1TileEntity, par2,
				par4, par6, par8);
	}
