...
public class ClientRenderBirchChest extends TileEntitySpecialRenderer {
	private static final ResourceLocation trap_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/trapped_double_birch.png".substring(1));

	private static final ResourceLocation trap_single = new ResourceLocation(
			"mod_idt", "/textures/entity/chest/trapped_birch.png".substring(1));

	private static final ResourceLocation normal_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/normal_double_birch.png".substring(1));

	private static final ResourceLocation normal_single = new ResourceLocation(
			"mod_idt", "/textures/entity/chest/normal_birch.png".substring(1));
	...
	public void renderTileEntityChestAt(
			TileEntityBirchChest par1TileEntityChest, double par2, double par4,
		...
		if (!par1TileEntityChest.hasWorldObj()) {
			...
			if (block instanceof BirchChest && i == 0) {
				try {
					((BirchChest) block).unifyAdjacentChests(
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		renderTileEntityChestAt((TileEntityBirchChest) par1TileEntity, par2,
				par4, par6, par8);
	}
