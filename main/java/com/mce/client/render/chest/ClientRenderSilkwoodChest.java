...
public class ClientRenderSilkwoodChest extends TileEntitySpecialRenderer {
	private static final ResourceLocation trap_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/trapped_double_silkwood.png".substring(1));

	private static final ResourceLocation trap_single = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/trapped_silkwood.png".substring(1));

	private static final ResourceLocation normal_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/normal_double_silkwood.png".substring(1));

	private static final ResourceLocation normal_single = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/normal_silkwood.png".substring(1));
	...
	public ClientRenderSilkwoodChest() {
	...
	public void renderTileEntityChestAt(
			TileEntitySilkwoodChest par1TileEntityChest, double par2,
		...
		if (!par1TileEntityChest.hasWorldObj()) {
			...
			if (block instanceof SilkwoodChest && i == 0) {
				try {
					((SilkwoodChest) block).unifyAdjacentChests(
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
			double par4, double par6, float par8) {
		renderTileEntityChestAt((TileEntitySilkwoodChest) par1TileEntity, par2,
				par4, par6, par8);
	}
