...
public class ClientRenderWillowChest extends TileEntitySpecialRenderer {
	private static final ResourceLocation trap_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/trapped_double_willow.png".substring(1));

	private static final ResourceLocation trap_single = new ResourceLocation(
			"mod_idt", "/textures/entity/chest/trapped_willow.png".substring(1));

	private static final ResourceLocation normal_double = new ResourceLocation(
			"mod_idt",
			"/textures/entity/chest/normal_double_willow.png".substring(1));

	private static final ResourceLocation normal_single = new ResourceLocation(
			"mod_idt", "/textures/entity/chest/normal_willow.png".substring(1));
	...
	public ClientRenderWillowChest() {
	...
	public void renderTileEntityChestAt(
			TileEntityWillowChest par1TileEntityChest, double par2,
		...
		if (!par1TileEntityChest.hasWorldObj()) {
			...
			if (block instanceof WillowChest && i == 0) {
				try {
					((WillowChest) block).unifyAdjacentChests(
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
			double par4, double par6, float par8) {
		renderTileEntityChestAt((TileEntityWillowChest) par1TileEntity, par2,
				par4, par6, par8);
	}
