...
public class ClientRenderNB extends RenderTNTPrimed {
	private RenderBlocks blockRenderer = new RenderBlocks();

	public ClientRenderNB() {
		this.shadowSize = 0.5F;
	}

	public void renderEB(EntityNB entity, double x, double y, double z,
		...
		this.blockRenderer.renderBlockAsItem(mod_IDT.NeptuniumBomb, 0,
		...
		if (entity.fuse / 5 % 2 == 0) {
			...
			this.blockRenderer
					.renderBlockAsItem(mod_IDT.NeptuniumBomb, 0, 1.0F);
	...
	public ResourceLocation textureLocation(EntityNB entity) {
