...
public class SkyRenderFrost extends IRenderHandler {
	...
	public void render(float ticks, WorldClient world, Minecraft mc) {
		...
		Vec3 vec3 = world.getSkyColor(mc.renderViewEntity, ticks);
		...
		float[] afloat = world.provider.calcSunriseSunsetColors(world.getCelestialAngle(ticks), ticks);
		float f7;
		float f8;
		float f9;
		float f10;
		if (afloat != null) {
			...
			GL11.glRotatef(MathHelper.sin(world.getCelestialAngleRadians(ticks)) < 0.0F ? 180.0F : 0.0F, 0.0F,
					0.0F, 1.0F);
			...
			tes.startDrawing(6);
			tes.setColorRGBA_F(f4, f7, f8, afloat[3]);
			tes.addVertex(0.0D, 100.0D, 0.0D);
			byte b0 = 16;
			tes.setColorRGBA_F(afloat[0], afloat[1], afloat[2], 0.0F);
			for (int j = 0; j <= b0; ++j) {
				f11 = (float) j * (float) Math.PI * 2.0F / (float) b0;
				float f12 = MathHelper.sin(f11);
				float f13 = MathHelper.cos(f11);
				tes.addVertex((double) (f12 * 120.0F), (double) (f13 * 120.0F),
		...
		GL11.glPushMatrix();
		f4 = 1.0F - world.getRainStrength(ticks);
		f7 = 0.0F;
		f8 = 0.0F;
		f9 = 0.0F;
		...
		tes.addVertexWithUV((double) f10, 100.0D, (double) (-f10), 1.0D, 0.0D);
		tes.addVertexWithUV((double) f10, 100.0D, (double) f10, 1.0D, 1.0D);
		...
		tes.startDrawingQuads();
		tes.addVertexWithUV((double) (-f10), -100.0D, (double) f10, (double) f16, (double) f17);
		tes.addVertexWithUV((double) f10, -100.0D, (double) f10, (double) f14, (double) f17);
		tes.addVertexWithUV((double) f10, -100.0D, (double) (-f10), (double) f14, (double) f15);
		tes.addVertexWithUV((double) (-f10), -100.0D, (double) (-f10), (double) f16, (double) f15);
		tes.draw();
		GL11.glDisable(GL11.GL_TEXTURE_2D);
		float f18 = world.getStarBrightness(ticks) * f4;
		if (f18 > 0.0F) {
		...
		double d0 = mc.thePlayer.getPosition(ticks).yCoord - world.getHorizon();
		if (d0 < 0.0D) {
			GL11.glPushMatrix();
			...
			tes.addVertex((double) (-f8), (double) f9, (double) f8);
			tes.addVertex((double) f8, (double) f9, (double) f8);
			tes.addVertex((double) f8, (double) f10, (double) f8);
			tes.addVertex((double) (-f8), (double) f10, (double) f8);
			tes.addVertex((double) (-f8), (double) f10, (double) (-f8));
			tes.addVertex((double) f8, (double) f10, (double) (-f8));
			tes.addVertex((double) f8, (double) f9, (double) (-f8));
