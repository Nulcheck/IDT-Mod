...
public class WorldChunkManagerCrystal extends WorldChunkManager {
	public static ArrayList<BiomeGenBase> allowBiomes = new ArrayList<BiomeGenBase>(
			Arrays.asList(BiomeRegistry.CrystalBiome));
	...
	protected WorldChunkManagerCrystal() {
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList();
		this.biomesToSpawnIn.addAll(allowBiomes);
	}

	public WorldChunkManagerCrystal(long seed, WorldType worldType) {
		this();
		GenLayer[] agenlayer = CrystalGenLayer.makeTheWorld(seed, worldType);
