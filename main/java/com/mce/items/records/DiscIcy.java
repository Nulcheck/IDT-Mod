...
public class DiscIcy extends ItemRecord {
	private static final Map cd = new HashMap();
	public final String cdName;

	public DiscIcy(String name) {
		super(name);
		this.cdName = name;
		this.maxStackSize = 1;
	...
	public static DiscIcy getRecord(String s) {
		return (DiscIcy) cd.get(s);
	}
