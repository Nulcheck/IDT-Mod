...
public class Discr51 extends ItemRecord {
	private static final Map cd = new HashMap();
	public final String cdName;

	public Discr51(String name) {
		super(name);
		this.cdName = name;
		this.maxStackSize = 1;
	...
	public static Discr51 getRecord(String s) {
		return (Discr51) cd.get(s);
	}
