...
public class TileEntitySilkwoodChest extends TileEntity implements IInventory {
	private ItemStack[] chestContents = new ItemStack[36];
	/** Determines if the check for adjacent chests has taken place. */
	public boolean adjacentChestChecked;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntitySilkwoodChest adjacentChestZNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntitySilkwoodChest adjacentChestXPos;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntitySilkwoodChest adjacentChestXNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntitySilkwoodChest adjacentChestZPos;
	...
	public TileEntitySilkwoodChest() {
		this.cachedChestType = -1;
	}

	@SideOnly(Side.CLIENT)
	public TileEntitySilkwoodChest(int i) {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.silkwoodChest";
	}
	...
	private void func_145978_a(TileEntitySilkwoodChest te, int i) {
		if (te.isInvalid()) {
			this.adjacentChestChecked = false;
	...
	public void checkForAdjacentChests() {
		if (!this.adjacentChestChecked) {
			...
			if (this.func_145977_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXNeg = (TileEntitySilkwoodChest) this.worldObj.getTileEntity(this.xCoord - 1,
						this.yCoord, this.zCoord);
			}

			if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXPos = (TileEntitySilkwoodChest) this.worldObj.getTileEntity(this.xCoord + 1,
						this.yCoord, this.zCoord);
			}

			if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
				this.adjacentChestZNeg = (TileEntitySilkwoodChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord,
						this.zCoord - 1);
			}

			if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
				this.adjacentChestZPos = (TileEntitySilkwoodChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord,
						this.zCoord + 1);
			}
	...
	private boolean func_145977_a(int x, int y, int z) {
		if (this.worldObj == null) {
			...
			return block instanceof SilkwoodChest && ((SilkwoodChest) block).field_149956_a == this.getChestType();
		}
	}
	...
	public void closeInventory() {
		if (this.getBlockType() instanceof SilkwoodChest) {
			--this.numPlayersUsing;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1,
					this.numPlayersUsing);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
	...
	public int getChestType() {
		if (this.cachedChestType == -1) {
			if (this.worldObj == null || !(this.getBlockType() instanceof SilkwoodChest)) {
				return 0;
			}

			this.cachedChestType = ((SilkwoodChest) this.getBlockType()).field_149956_a;
		}
