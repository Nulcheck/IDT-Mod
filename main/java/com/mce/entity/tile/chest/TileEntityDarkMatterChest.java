...
public class TileEntityDarkMatterChest extends TileEntity implements IInventory {
	private ItemStack[] chestContents = new ItemStack[36];
	/** Determines if the check for adjacent chests has taken place. */
	public boolean adjacentChestChecked;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityDarkMatterChest adjacentChestZNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityDarkMatterChest adjacentChestXPos;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityDarkMatterChest adjacentChestXNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityDarkMatterChest adjacentChestZPos;
	...
	public TileEntityDarkMatterChest() {
		this.cachedChestType = -1;
	}

	@SideOnly(Side.CLIENT)
	public TileEntityDarkMatterChest(int i) {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.darkMatterChest";
	}
	...
	private void func_145978_a(TileEntityDarkMatterChest te, int i) {
		if (te.isInvalid()) {
			this.adjacentChestChecked = false;
	...
	public void checkForAdjacentChests() {
		if (!this.adjacentChestChecked) {
			...
			if (this.func_145977_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXNeg = (TileEntityDarkMatterChest) this.worldObj.getTileEntity(this.xCoord - 1,
						this.yCoord, this.zCoord);
			}

			if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXPos = (TileEntityDarkMatterChest) this.worldObj.getTileEntity(this.xCoord + 1,
						this.yCoord, this.zCoord);
			}

			if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
				this.adjacentChestZNeg = (TileEntityDarkMatterChest) this.worldObj.getTileEntity(this.xCoord,
						this.yCoord, this.zCoord - 1);
			}

			if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
				this.adjacentChestZPos = (TileEntityDarkMatterChest) this.worldObj.getTileEntity(this.xCoord,
						this.yCoord, this.zCoord + 1);
			}
	...
	private boolean func_145977_a(int x, int y, int z) {
		if (this.worldObj == null) {
			...
			return block instanceof DarkMatterChest && ((DarkMatterChest) block).field_149956_a == this.getChestType();
		}
	}
	...
	public void closeInventory() {
		if (this.getBlockType() instanceof DarkMatterChest) {
			--this.numPlayersUsing;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1,
					this.numPlayersUsing);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
	...
	public int getChestType() {
		if (this.cachedChestType == -1) {
			if (this.worldObj == null || !(this.getBlockType() instanceof DarkMatterChest)) {
				return 0;
			}

			this.cachedChestType = ((DarkMatterChest) this.getBlockType()).field_149956_a;
		}
