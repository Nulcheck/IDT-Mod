...
public class EntityIcyCreeperAI extends EntityMob {
	/**
	...
	public EntityIcyCreeperAI(World p_i1733_1_) {
		super(p_i1733_1_);
	 ...
	 */
	protected void fall(float dam) {
		super.fall(dam);
		this.timeSinceIgnited = (int) ((float) this.timeSinceIgnited + dam * 1.5F);
	...
	public void readEntityFromNBT(NBTTagCompound tag) {
		...
		this.dataWatcher.updateObject(17,
				Byte.valueOf((byte) (tag.getBoolean("powered") ? 1 : 0)));
		...
		if (!this.worldObj.isRemote) {
			...
			if (this.getPowered()) {
				this.worldObj.createExplosion(this, this.posX, this.posY,
						this.posZ, (float) (this.explosionRadius * 2), flag);
			} else {
				this.worldObj.createExplosion(this, this.posX, this.posY,
						this.posZ, (float) this.explosionRadius, flag);
			}
